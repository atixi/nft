...
function AssetCard({ asset }) {
    return (<div className=" col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div className="nft__item style-2" style={{ border: "1px solid #e6e2e2" }}>
            ...
            <UserAvatar user={{ userName: asset?.talent?.userName, avatar: asset?.asset?.owner?.profile_img_url, verified: asset.isInternal }} />
            ...
            <div className="nft__item_info">
                ...
                <div className="nft__item_price">
                    <span> {asset?.asset?.sellOrders?.length > 0 ? `${getAuctionPriceDetails(asset?.asset?.sellOrders[0]).priceBase} ${asset?.asset?.sellOrders[0]?.paymentTokenContract.symbol}` : ""}
