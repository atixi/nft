    ...
    return <>
        ...
        <Modal title="Make an Offer" visible={isModalVisible} onCancel={handleCancel}
            ...
            <Button key="submit" form={"makeOffer"} htmlType={"submit"} type="primary">
                ...
                >
                        <Select defaultValue={"1"} type={"object"} size={"large"} onChange={handleTimeChange} style={{width: "25%"}}>
                    ...
                    rules={[{ required: true, message: 'Time is required' }]}>
                        <TimePicker type={"object"} defaultValue={moment('12:08:23', 'HH:mm:ss')} style={{ width: '75%' }}  size="large" />
                    </Form.Item>
                    :
                    <Form.Item
                    name={['dateTime', 'date']}
