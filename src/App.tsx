    ...
    return (
      <div className="App">
        ...
        <main className="App-main">
          ...
          <iframe id="opensea-iframe" title="Embedded OpenSea Marketplace" src={embeddedUrl} width='100%' height='100vh' frameBorder='0' scrolling="auto"  style={{minHeight: '200vh', pointerEvents: 'auto'}}></iframe>
        </main>
